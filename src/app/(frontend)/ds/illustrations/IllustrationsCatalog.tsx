...
const LIVE_PRESETS: Record<string, string> = {
  ...
  'page/donate': '/donate',
  'page/welfare-sharia': '/donate/zakat',
  'page/donations': '/donate/general',
  'page/sadaqah': '/donate/sadaqah',
  'page/eidi-fitrana': '/donate/eidi-fitrana',
  'page/how-to-donate': '/donate/how-to-donate',
  'page/donate-online': '/donate/how-to-donate/online',
  'page/mobile-wallet': '/donate/how-to-donate/mobile-wallet',
  'page/bank-transfer': '/donate/how-to-donate/bank-transfer',
  'page/meezan-app': '/donate/how-to-donate/meezan-app',
  'page/cheque-donation': '/donate/how-to-donate/cheque',
  'page/pick-up-donation': '/donate/how-to-donate/pick-up',
  'page/what-you-can-support': '/donate/what-you-can-support',
  'page/donate-a-meal': '/donate/what-you-can-support/donate-a-meal',
  'page/donate-in-kind': '/donate/what-you-can-support/donate-in-kind',
  'page/sponsor-a-patient': '/donate/what-you-can-support/sponsor-a-patient',
  'page/sponsor-free-surgeries': '/donate/what-you-can-support/sponsor-free-surgeries',
  'page/support-a-project': '/donate/what-you-can-support/support-a-project',
