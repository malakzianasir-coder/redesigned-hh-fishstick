...
export function WaysToGiveSection({
  ...
  hideBlockHeaderCta = false,
}: WaysToGiveSectionProps) {
  ...
  return (
    ...
    <section id={sectionId} className="section-anchor border-t border-dark-gray/15 bg-white">
      ...
      <div className="container mx-auto flex flex-col gap-8 px-6 py-[30px] lg:px-[30px] lg:py-[60px]">
        ...
        <BlockHeader
          ...
          cta={hideBlockHeaderCta ? undefined : content.cta}
